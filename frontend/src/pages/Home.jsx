...
function RegistrationSection({ registration, details, images, activeImage, now, events }) {
  ...
  const countdown = enrollmentStarted ? null : getCountdown(registration.fecha_apertura, now);
