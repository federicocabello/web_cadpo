...
function EventSection({ event, now, onShowCalendar, registrationPrompt, showLiveTiming }) {
  ...
  return (
    <section className="home-race-height race-hero relative overflow-hidden bg-black">
      ...
      <div className="home-race-height relative z-10 mx-auto grid w-full max-w-[1600px] grid-cols-1 items-center gap-4 px-5 py-10 sm:px-8 lg:grid-cols-[minmax(0,1fr)_minmax(360px,1fr)] lg:gap-16 lg:px-14 lg:py-12 xl:gap-24 xl:px-20">
